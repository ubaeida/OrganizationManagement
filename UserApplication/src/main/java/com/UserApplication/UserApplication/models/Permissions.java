    ...
    final String permissions = """
                {
                    ...
                    "CASE_MANAGEMENT_OFFICER":["VIEW_PROFILE" ,"VIEW_CASES", "CREATE_CASE", "EDIT_CASE", "DELETE_CASE", "ASSIGN_CASE"],
                    "CASEWORKER":["VIEW_PROFILE", "VIEW_CASES", "CREATE_CASE", "EDIT_CASE", "DELETE_CASE"],
                    "OUTREACH_OFFICER":["VIEW_PROFILE" ,"VIEW_ASSESSMENT", "CREATE_ASSESSMENT", "EDIT_ASSESSMENT", "DELETE_ASSESSMENT", "REFER_ASSESSMENT"],
