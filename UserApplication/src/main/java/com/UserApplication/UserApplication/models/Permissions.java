...
public class Permissions {
    ...
    final String permissions = """
                {
                    "ADMINISTRATOR": ["*"],
                    "HEAD_OFFICE":["VIEW_PROFILE", "VIEW_USERS", "VIEW_CASES", "UPDATE_CASE_STATUS"],
                    "HR": ["VIEW_PROFILE", "VIEW_USERS", "EDIT_USER", "CREATE_USER", "DELETE_USER"],
                    "CASE_MANAGEMENT_OFFICER":["VIEW_PROFILE" ,"VIEW_CASES", "CREATE_CASE", "EDIT_CASE", "DELETE_CASE", "UPDATE_CASE_STATUS", "ACCEPT_CASE", "view_approved_candidates", "APPROVE_ASSESSMENT"],
                    "CASEWORKER":["VIEW_PROFILE", "VIEW_CASES", "CREATE_CASE", "EDIT_CASE", "DELETE_CASE", "UPDATE_CASE_STATUS"],
